...
class Pricing(DriverWrapper):
    ...
    def click_pricing_nav_link(self):
        return self.click_element(self._pricing_nav_link)

    def click_unlimited_session_option(self):
        return self.click_element(self._unlimited_session_option)

    def click_default_card(self, default_card):
        self._default_card["locator"] = self._default_card["locator"].format(
            default_card=default_card
        )
        return self.click_element(self._default_card)

    def click_purchase_button(self):
        return self.click_element(self._purchase_button)
